    ...
    <body>
        ...
        <main class="ls-main ">
            <div class="container col-md-12">
                <h1 class="ls-title-intro ls-ico-plus"> Unidades de Sáude </h1>
                ...
                <div class="view-form">  
                    ...
                    <form action="#" name="unidadeSv" class="form-horizontal" method="post">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading"><span class="glyphicon glyphicon-plus-sign"></span> Inserir Unidade de Saúde</div>
                    ...
                    <form action="#" name="topoSV" class="form-horizontal" method="post">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label for="noticiatopo" class="control-label col-md-2"> Unidade de Saúde: </label>
                                    <div class="col-md-4">           
                                        <input type="text" class="form-control" name="removetopo" maxlength="60" placeholder="Digite o nome"  required>
                                    </div>
                                    <div class="col-md-6">
                                        <span id="load"></span>
